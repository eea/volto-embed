pipeline {
  ...
  environment {
        ...
        NAMESPACE = "@eeacms"
        SONARQUBE_TAGS = "volto.eea.europa.eu,climate-energy.eea.europa.eu,forest.eea.europa.eu,water.europa.eu-freshwater,biodiversity.europa.eu,water.europa.eu-marine,climate-adapt.eea.europa.eu"
        DEPENDENCIES = ""
        VOLTO = ""
    }
